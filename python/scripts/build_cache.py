...
Artifacts written to ``THINGS_CACHE_DIR`` (default ``python/cache/``):
...
from things_spose import analyses, artifacts, backend, dataio, paths, similarity
